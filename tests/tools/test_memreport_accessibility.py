...
from cerebrus.tools.memreport.tool import generate_html_report, HTML_TEMPLATE
...
def test_html_accessibility_features():
    ...
    try:
        ...
        assert 'title="Toggle Light/Dark Mode"' in content or 'aria-label="Toggle Light/Dark Mode"' in content
        
        # 6. Check for meaningful headers
        assert '<h1>MemReport - Test Device</h1>' in content or '<h1>Memory Report</h1>' in content
