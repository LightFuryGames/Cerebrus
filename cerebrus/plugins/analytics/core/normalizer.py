...
RAW_TO_CANONICAL_KEYS = {
    ...
    "loading screen duration (s)": "loading_screen_duration_s",
    ...
    "memory rss peak mb": "memory_rss_peak_mb",
    "memory swap peak mb": "memory_swap_peak_mb",
    "memory total used peak mb": "memory_total_used_peak_mb",
    "mvp60": "mvp60",
    ...
    "cpu temp avg (c)": "cpu_temp_avg_c",
    "cpu temp max (c)": "cpu_temp_max_c",
    "thermal status max": "thermal_status_max",
    "thermal stress avg": "thermal_stress_avg",
    "thermal stress max": "thermal_stress_max",
    "cpu freq group 0 avg mhz": "cpu_freq_group0_avg_mhz",
    "cpu freq group 1 avg mhz": "cpu_freq_group1_avg_mhz",
    "cpu freq group 0 avg %": "cpu_freq_group0_avg_pct",
    "cpu freq group 1 avg %": "cpu_freq_group1_avg_pct",
...
GROUPS = {
    ...
    "metrics": {
        ...
        "memory_rss_peak_mb",
        "memory_swap_peak_mb",
        "memory_total_used_peak_mb",
        "cpu_temp_avg_c",
        "cpu_temp_max_c",
        "thermal_status_max",
        "thermal_stress_avg",
        "thermal_stress_max",
        "cpu_freq_group0_avg_mhz",
        "cpu_freq_group1_avg_mhz",
        "cpu_freq_group0_avg_pct",
        "cpu_freq_group1_avg_pct",
        "mvp60",
