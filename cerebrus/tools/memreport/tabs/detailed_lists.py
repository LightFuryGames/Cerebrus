...
from ..utils import try_format_cell_value, format_memory_size
...
class DetailedListsTab(ReportTab):
    ...
    def parse(self, line: str, context: Dict[str, Any]) -> None:
        ...
        if self.current_class == "Textures":
             ...
             if "Listing all textures" in line: return
             if "MemReport: Begin" in line: return # Skip start line
        ...
        # 2. Parsing Logic for Generic Classes
             ...
             if not line.strip(): return
             if "Obj List:" in line or "Objects:" in line: return
             if "MemReport: Begin" in line: return
